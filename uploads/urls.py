...
urlpatterns = [
    ...
    path("ads-master-bs", views.ads_master_bs_list, name="ads-master-bs-list"),
    path("ads-master-bs/add", views.ads_master_bs_create, name="ads-master-bs-add"),
    path("ads-master-bs/update", views.ads_master_bs_update, name="ads-master-bs-update"),
    path("ads-master-bs/delete", views.ads_master_bs_delete, name="ads-master-bs-delete"),
