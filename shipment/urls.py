...
urlpatterns = [
    ...
    path('shipments/<int:pk>/invoice/', views.ShipmentInvoiceView.as_view(), name='shipment-invoice'),
    path('shipments/<int:pk>/invoice/file/', views.ShipmentInvoiceFileView.as_view(), name='shipment-invoice-file'),
