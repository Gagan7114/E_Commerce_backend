...
urlpatterns = [
    ...
    path('shipments/<int:pk>/po-documents/', views.ShipmentPoDocumentsView.as_view(), name='shipment-po-documents'),
    path('shipments/<int:pk>/po-documents/<str:po_number>/', views.ShipmentPoDocumentFileView.as_view(), name='shipment-po-document-file'),
    path('shipments/<int:pk>/invoices/', views.ShipmentInvoiceListView.as_view(), name='shipment-invoices'),
    path('shipments/<int:pk>/invoices/<int:invoice_id>/', views.ShipmentInvoiceDetailView.as_view(), name='shipment-invoice-detail'),
    path('shipments/<int:pk>/invoices/<int:invoice_id>/file/', views.ShipmentInvoiceFileView.as_view(), name='shipment-invoice-file'),
